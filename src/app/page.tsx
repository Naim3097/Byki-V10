...
export default function HomePage() {
  ...
  return (
    <div className="relative">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {FEATURES.map((f) => (
            <Link key={f.title} href={f.href} className="group">
              <Card hover className={`h-full flex flex-col items-center text-center sm:items-start sm:text-left gap-3 animate-fade-up ${f.primary ? 'border-[var(--accent)]/15' : ''}`} >
      ...
      {/* ── Bengkel Onex BYKI ────────────────────── */}
      <section className="relative max-w-3xl md:max-w-md mx-auto px-6 pb-16">
      ...
      <section className="relative max-w-3xl mx-auto px-6 pb-16">
        <div className="relative overflow-hidden rounded-2xl border border-[var(--accent)]/10 bg-gradient-to-br from-[var(--accent)]/[0.03] to-transparent p-6 sm:p-10 text-center">
          ...
          <div className="relative space-y-4">
            <div className="flex justify-center">
              <Image src="/IOS.png" alt="BYKI App for iOS and Android" width={280} height={280} className="object-contain" />
            </div>
            <div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[#25D366]/15 bg-gradient-to-br from-[#25D366]/[0.04] to-transparent p-6 sm:p-8 text-center">
          ...
          <div className="relative space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                href="https://wa.me/60199705364?text=Hi%2C%20I%27d%20like%20to%20know%20more%20about%20BYKI%20vehicle%20diagnostics."
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://wa.me/60199705364?text=Hi%2C%20I%27d%20like%20a%20live%20video%20call%20consultation%20for%20my%20vehicle."
                target="_blank"
                rel="noopener noreferrer"
